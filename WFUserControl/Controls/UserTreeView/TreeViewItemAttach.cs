...
namespace WFUserControl
{
    ...
    /// TreeViewItem附加属性
    /// </summary>
    public static class TreeViewItemAttach
    {
        //
        ...
        /// <summary>
        /// 使用该附加属性代替IsMouseOver
        /// 解决鼠标悬停在树节点上触发悬停效果时，其子节点也触发了悬停效果的问题
        /// </summary>
        ...
        private static readonly RoutedEvent UpdateOverItemEvent = EventManager.RegisterRoutedEvent(
            "UpdateOverItem", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(TreeViewItemAttach));

        //
        // Class constructor
        //
        static TreeViewItemAttach()
        {
